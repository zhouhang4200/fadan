...
return [
    ...
    'wanzi' => [
    	...
    	'url' => [
			'onSale'                   => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/onsale', // 上架
			'offSale'                  => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/offsale', // 下架
			'applyRevoke'              => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/apply-consult', // 申请撤销
			'cancelRevoke'             => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/cancel-consult', // 取消撤销
			'agreeRevoke'              => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/agree-consult', // 同意撤销
			'refuseRevoke'             => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/reject-consult', // 不同意撤销
			'applyArbitration'         => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/apply-complain', // 申请仲裁
			'cancelArbitration'        => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/cancel-complain', // 取消仲裁
			'complete'                 => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/complete', // 订单完成
			'lock'                     => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/lock', // 锁定
			'cancelLock'               => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/cancel-lock',// 取消锁定
			'delete'                   => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/delete', // 删除订单
			'orderDetail'              => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/detail', // 订单详情
			'addTime'                  => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/add-time', // 加时
			'addMoney'                 => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/add-money', // 加款
			'updateAccountAndPassword' => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/update-account-password', // 修改账号密码
			'updateOrder'              => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/update', // 修改订单
			'getScreenshot'            => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/apply-complete-image', // 订单截图
			'addArbitrationInfo'       => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/complain-message', // 添加仲裁证据
			'getMessage'               => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/get-message', //获取留言
			'replyMessage'             => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/send-message', // 回复留言
			'getArbitrationInfo'       => env('WANZI_API_URL', 'http://www.fulugou.net').'/api/order/tm/get-complain-info', // 查看仲裁详情
