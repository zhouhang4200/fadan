...
class CreatePlatformOrderStatisticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_statistics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('platform_order_statistics');
    }
}
