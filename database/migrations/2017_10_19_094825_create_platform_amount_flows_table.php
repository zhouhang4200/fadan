...
class CreatePlatformAmountFlowsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('platform_amount_flows', function (Blueprint $table) {
            ...
            $table->unsignedInteger('trade_type')->comment('交易类型:  1.用户加款 2.用户提现 3.用户冻结 4.用户解冻 5.用户消费 6.退款给用户 7.用户支出 8.用户收入');
            $table->unsignedInteger('trade_subtype')->comment('交易子类型: 11.自动加款 12.手动加款 21.手动提现 31.提现冻结 32.抢单冻结 41.提现解冻 42.抢单解冻 51.消费手续费 61.手续费退款 71.订单集市支出 81.订单集市收入');
