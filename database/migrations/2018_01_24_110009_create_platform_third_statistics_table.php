...
class CreatePlatformThirdStatisticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_third_statistics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('platform_third_statistics');
    }
}
