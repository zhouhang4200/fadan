...
+ function($) {
  ...
  $.prompt = function(text, title, onOK, onCancel, input) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p><input type="password" style="text-align:center" class="weui-input weui-prompt-input" id="weui-prompt-input" plactholder = "请输入支付密码" value="' + (config.input || '') + '" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
