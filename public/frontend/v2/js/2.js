...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/frontend/js/components/order/game-leveling/Create.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        ...
        return {
            ...
            rules: {
                ...
                game_account: [{ required: true, message: '请输入游戏账号', trigger: 'blur' }],
                game_password: [{ required: true, message: '请输入游戏密码', trigger: 'blur' }],
                title: [{ required: true, message: '请输入代练标题', trigger: 'blur' }, { min: 3, max: 35, message: '长度在 3 到 35 个字符', trigger: 'blur' }],
                day_hour: [
                // {type: 'array', required: true, message: '请选择代练天/小时',  trigger: 'change'},
                {
                    validator: function validator(rule, value, callback) {
                        if (_this.form.day == 0 && _this.form.hour == 0) {
                ...
                explain: [{ required: true, message: '请输入代练说明', trigger: 'blur' }],
                requirement: [{ required: true, message: '请输入代练要求', trigger: 'blur' }],
                ...
                user_qq: [{ required: true, message: '请选择商户QQ', trigger: 'blur' }],
    ...
    methods: {
        ...
        // 模板使用说明
        handleOrderTemplateGuide: function handleOrderTemplateGuide() {
            this.$alert('1.选择“游戏”后会自动显示对应模板。<br>' + '2.将模版复制，发给号主填写。<br>' + '3.粘贴号主填写好的模版，粘贴至模板输入框内。<br>' + '4.点击“解析模板”按钮将资料导入至左侧表格内，点击“发布”按钮，即可创建订单。', '使用说明', {
                confirmButtonText: '确定',
                dangerouslyUseHTMLString: true
            });
        },
        handelTaobaoData: function handelTaobaoData() {
            var _this5 = this;

            this.$api.taobaoOrderShow({ tid: this.tid }).then(function (res) {
                _this5.taobaoData = [{
                    name: '店铺名',
        ...
        businessmanQQOption: function businessmanQQOption() {
            ...
            this.$api.businessmanContactTemplate().then(function (res) {
                _this6.businessmanQQOptions = res.data;
            });
        },
        ...
        gameLevelingRequirementOption: function gameLevelingRequirementOption() {
            ...
            this.$api.gameLevelingRequirementTemplate().then(function (res) {
                _this7.gameLevelingRequirementOptions = res.data;
            });
        },
        ...
        handleBusinessmanQQIdChange: function handleBusinessmanQQIdChange() {
            var vm = this;
            this.businessmanQQOptions.forEach(function (item) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8ea379e2\",\"scoped\":false,\"hasInlineConfig\":true}!./node_modules/less-loader/dist/cjs.js!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/assets/frontend/js/components/order/game-leveling/Create.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8ea379e2\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/frontend/js/components/order/game-leveling/Create.vue":
/***/ (function(module, exports, __webpack_require__) {
                                                          ...
                                                          [
                                                            _c(
                                                              "el-select",
                                                              {
                                                                ...
                                                                on: {
                                                                  change:
                                                                    _vm.handleBusinessmanQQIdChange
                                                                },
                                                                model: {
                                                                  value:
                                                                    _vm.form
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "el-tab-pane",
                          { attrs: { label: "发单模板", name: "2" } },
                          [
                            _c("el-input", {
                              attrs: { type: "textarea", rows: "20" },
                              model: {
                                value: _vm.orderTemplate,
                                callback: function($$v) {
                                  _vm.orderTemplate = $$v
                                },
                                expression: "orderTemplate"
                              }
                            }),
                            _vm._v(" "),
                            _c(
                              ...
                              [
                                ...
                                _c(
                                  "el-button",
                                  {
                                    on: { click: _vm.handleOrderTemplateGuide }
                                  },
                                  [_vm._v("使用说明")]
                                )
                              ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8ea379e2", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("1bec341d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8ea379e2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../../node_modules/less-loader/dist/cjs.js!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Create.vue", function() {
     var newContent = require("!!../../../../../../../node_modules/css-loader/index.js!../../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8ea379e2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../../node_modules/less-loader/dist/cjs.js!../../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Create.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./resources/assets/frontend/js/components/order/game-leveling/Create.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/assets/frontend/js/components/order/game-leveling/Create.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-8ea379e2\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/assets/frontend/js/components/order/game-leveling/Create.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = injectStyle
...
Component.options.__file = "resources/assets/frontend/js/components/order/game-leveling/Create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8ea379e2", Component.options)
  } else {
    hotAPI.reload("data-v-8ea379e2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
