$(function ($) {
    ...
    if (storage) {
        try {
            ...
            var sidebarStyle = localStorage.getItem('config-sidebar-style');

            if (sidebarStyle != null) {
                $('#page-wrapper').attr('class', sidebarStyle);
            }
    ...
    $('#make-small-nav').on('click', function () {
        var sidebarIsSmall = $('#page-wrapper').hasClass('nav-small');
        var sidebarClass;
        if (sidebarIsSmall) {
            sidebarClass = 'container';
        } else {
            sidebarClass = 'container nav-small';
        }
        writeStorage(storage, 'config-sidebar-style', sidebarClass);
    });
