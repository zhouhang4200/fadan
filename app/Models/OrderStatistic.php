...
{
    protected $fillable = [
    	'date', 'user_id', 'parent_id', 'send_order_count', 
        'receive_order_count', 'complete_order_count', 
        'complete_order_rate', 'revoke_order_count', 'arbitrate_order_count', 
        'three_status_original_amount', 'complete_order_amount', 
        'two_status_payment', 'two_status_income', 'poundage', 'profit',
    ];
