            ...
            $order->chunk(300, function ($items) use ($out) {
                foreach ($items as $item) {
                    ...
                    $data = [
                        ...
                        $orderCurrent['game_name']  .'/' . $orderCurrent['region'] . '/' . $orderCurrent['serve'],
                        '账号:' . $orderCurrent['account'] . ' 密码:' .  $orderCurrent['password'],
                        $orderCurrent['role'],
                        $orderCurrent['amount'],
                        $orderCurrent['efficiency_deposit'] . '/' . $orderCurrent['security_deposit'],
                        $orderCurrent['created_at'] . '/' . $orderCurrent['receiving_time'],
