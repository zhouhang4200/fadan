...
export default {
    ...
    gameLevelingOrderCreate(params) {
        return post('/v2/order/game-leveling/store', params);
    },
    // 游戏代练 订单数据
    ...
    // 游戏代练订单 更新
    gameLevelingOrderUpdate(params) {
        return post('/v2/order/game-leveling/update', params);
    },
    // 游戏代练订单 详情
    ...
    // 游戏代练订单备注
    gameLevelingOrderUserRemark(params) {
        return post('/v2/order/game-leveling/update-user-remark', params);
    },
    // 淘宝订单 待发订单）状态数量
    ...
    // 游戏代练模板 列表
    gameLevelingRequirementTemplate(params) {
        return post('/v2/setting/game-leveling-requirement-template', params);
    },
    // 游戏代练模板 增加/修改
    gameLevelingRequirementTemplateStore(params) {
        return post('/v2/setting/game-leveling-requirement-template/store', params);
    },
    // 游戏代练模板 查看
    gameLevelingRequirementTemplateShow(params) {
        return post('/v2/setting/game-leveling-requirement-template/show', params);
    },
    // 游戏代练模板 删除
    gameLevelingRequirementTemplateDelete(params) {
        return post('/v2/setting/game-leveling-requirement-template/delete', params);
    },
    // 商户联系方式 列表
    businessmanContactTemplate(params) {
        return post('/v2/setting/businessman-contact-template', params);
    },
    // 商户联系方式 增加/修改
    businessmanContactTemplateStore(params) {
        return post('/v2/setting/businessman-contact-template/store', params);
    },
    // 商户联系方式 查看
    businessmanContactTemplateShow(params) {
        return post('/v2/setting/businessman-contact-template/show', params);
    },
    // 商户联系方式 删除
    businessmanContactTemplateDelete(params) {
        return post('/v2/setting/businessman-contact-template/delete', params);
    }
}