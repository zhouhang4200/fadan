...
@section('content')
    <div class="main" style="text-align: center;">
        ...
        <div class="footer">
            <a class="weui-btn weui-btn_default tb-bg" href="{{ route('channel.show', ['id' => $gameLevelingChannelOrder->id]) }}" style="margin-right: 1px;">订单详情</a>
            <a class="weui-btn weui-btn_default tb-bg" id="close" href="{{ route('channel.index') }}">关闭</a>
        </div>
    </div>
@endsection
@section('js')
