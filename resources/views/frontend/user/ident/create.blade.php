...
@section('css')
    <style>
        ...
        .ident >.layui-form-item >.layui-form-label{
            width: 100px;
        }
        .ident >.layui-form-item >.layui-input-block{
            margin-left: 150px;
         }
        .ident >.layui-form-item >.layui-upload >.layui-btn{
            margin-left: 20px;
        }
        .ident >.layui-form-item >.layui-upload >.layui-upload-list{
            width: 300px;
            height: 300px;
            margin-left: 150px;
        }
        .ident >.layui-form-item >.layui-upload >.layui-upload-list >img{
            width: 100%;
            height: 100%;
        }
    </style>
