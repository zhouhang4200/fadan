<form class="layui-form" id="category-form">
    <div class="layui-form-item">
        ...
        <button class="qs-btn layui-btn-normal fr" data-type="{{ $type }}" lay-submit lay-filter="category-add">添加用户ID</button>
    </div>
</form>
...
<table class="layui-table" lay-size="sm">
    ...
    @forelse($controlCategoryList as $item)
        <tr>
            ...
            <td>
                <button class="qs-btn layui-btn-normal layui-btn-small" data-id="{{ $item->id }}" lay-submit="" lay-filter="delete-category">删除</button>
            </td>
        </tr>
    @empty
