                ...
                <form class="layui-form" action="" lay-filter="component-form-group" id="form-order">
                    ...
                    <div class="layui-row layui-col-space10 layui-form-item">
                        ...
                        <div class="layui-col-lg6">
                            ...
                            <div class="layui-input-block">
                                <select name="game_id" lay-filter="game" lay-verify="required">
                                    <option value=""></option>
                        ...
                        <div class="layui-col-lg6">
                            ...
                            <div class="layui-input-block ">
                                <select name="region" lay-verify="required" id="region" lay-filter="region" class="region" display-name="区">
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-row layui-col-space10 layui-form-item">
                        <div class="layui-col-lg6">
                            ...
                            <div class="layui-input-block">
                                <select name="serve" id="server" lay-verify="required" lay-filter="serve"  class="serve" display-name="服">
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-row layui-col-space10 layui-form-item">
                        <div class="layui-col-lg6">
                            ...
                            <div class="layui-input-block">
                                <select name="game_leveling_type" id="game_leveling_type" lay-verify="required"  lay-filter="game_leveling_type" class="leveling_type" display-name="代练类型">
                                </select>
                            </div>
                        </div>
                        <div class="layui-col-lg6">
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate', 'laytpl', 'element'], function(){
            ...
            form.on('select(game)', function (data) {
                $.post('{{ route('frontend.workbench.regions') }}', {game_id:data.value}, function(result){
                    // console.log(result.regions);
                    // console.log(result.gameLevelingTypes);

                    if (result.code == 1) {

                        var region = '';
                        $.each(result.regions, function (i, item) {
                            itemvalue = item.replace(/[a-zA-Z0-9]+\-/i, '');
                            region += "<option value='"+i+"'>"+itemvalue+"</option>";
                        })

                        $('#region').html('<option value="请选择"></option>' + region);

                        var game_leveling_type = '';
                        $.each(result.gameLevelingTypes, function (i, item) {
                            itemvalue = item.replace(/[a-zA-Z0-9]+\-/i, '');
            ...
            form.on('select(region)', function (data) {
                $.post('{{ route('frontend.workbench.servers') }}', {region_id:data.value}, function(result){
                    if (result) {
                        var server = '';
                        $.each(result, function (i, item) {
                            itemvalue = item.replace(/[a-zA-Z0-9]+\-/i, '');
                            server += "<option value='"+i+"'>"+itemvalue+"</option>";
                        })

                        $('#server').html('<option value="请选择"></option>' + server);
                        form.render('select');
                    } else {
                        $('#server').html('');
                        form.render('select');
