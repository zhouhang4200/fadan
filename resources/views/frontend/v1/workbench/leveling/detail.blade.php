                        ...
                        <form class="layui-form" action="" lay-filter="component-form-group" id="form-order">
                            ...
                            <div class="layui-row layui-col-space10 layui-form-item">
                                ...
                                <div class="layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="password" lay-verify="required|pwd" placeholder="" autocomplete="off" class="layui-input" display-name="密码"  @if(!in_array($detail['status'], [1, 22]))  disabled="disabled"  @endif value="{{ $detail['password'] ?? '' }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layui-row layui-col-space10 layui-form-item">
                                <div class="layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="security_deposit" @if(!$detail['gainer_user_id'] != 0) lay-verify="required|number|gt5" @endif placeholder="" autocomplete="off" class="layui-input" display-name="安全保证金"  @if(!in_array($detail['status'], [1, 22]))  disabled="disabled"  @endif value="{{ $detail['security_deposit'] ?? '' }}">
                                ...
                                <div class="layui-col-lg6">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="efficiency_deposit" @if(!$detail['gainer_user_id']) lay-verify="required|number|gt5" @endif placeholder="" autocomplete="off" class="layui-input" display-name="效率保证金"  @if(!in_array($detail['status'], [1, 22]))  disabled="disabled"  @endif value="{{ $detail['efficiency_deposit'] ?? '' }}">
                            ...
                            <div class="layui-row layui-col-space10 layui-form-item">
                                ...
                                <div class="layui-col-lg6">
                                    @if($detail['gainer_user_id'])
                                    <label class="layui-form-label">指定内部打手</label>
                                    <div class="layui-input-block">
                                        <select name="gainer_user_id" disabled  lay-filter="gainer-primary-user-id">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                    @endif
