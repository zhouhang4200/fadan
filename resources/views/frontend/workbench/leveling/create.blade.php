                ...
                <div class="layui-row form-group">
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-col-md8">
                            <select name="game_id" lay-verify="required" lay-search="" show-name="x" display-name="游戏">
        ...
        <div class="layui-col-md3">
            ...
            <div class="layui-row " style="margin-bottom: 15px">
                <div class="layui-col-md4">
                    <div class="layui-btn layui-btn-normal layui-col-md12" lay-submit="" lay-filter="analysis-template" id="parse">解析模板</div>
                </div>
