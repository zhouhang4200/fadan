                ...
                <div class="" style="text-align: right;">
                    @if($detail['status'] != 24)
                        ...
                        @if (in_array($detail['status'], [13, 14, 17, 18]))
                            <button lay-submit=""   lay-filter="operation" class="layui-btn layui-btn-normal"  data-operation="revoke" data-no="{{ $detail['no'] }}" data-safe="{{ $detail['security_deposit'] ?? '' }}" data-effect="{{ $detail['efficiency_deposit'] ?? '' }}" data-amount="{{ $detail['amount'] }}">申请撤销</button>
                        @endif
