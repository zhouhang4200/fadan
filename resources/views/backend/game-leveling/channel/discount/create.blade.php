        ...
        <div class="main-box-body clearfix">
            <div class="layui-tab layui-tab-brief" lay-filter="widgetTab">
                ...
                <div class="layui-tab-content">
                    ...
                    <form class="form-horizontal layui-form" role="form" method="post" action="{{ route('game-leveling.channel.discount.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="discount" lay-verify="required" value="{{ old('discount') }}" autocomplete="off" placeholder="请输入" class="layui-input">
                            </div>
                        </div>
