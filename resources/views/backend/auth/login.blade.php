                    ...
                    <div class="warp">
                        <div class="content">
                            ...
                            <form method="POST" action="{{ route('admin.post.login') }}" class="layui-form">
                                ...
                                <div class="layui-form-item ">
                                    <input type="password" name="code" required="" lay-verify="required"
                                           placeholder="请输入动态口令" autocomplete="off"
                                           class="layui-input layui-form-danger input-text">
                                    <i class="layui-icon icon"> &#x1005;</i>
                                </div>
                                <div class="layui-form-item">
                                    <button class="submit" lay-submit lay-filter="formDemo" style="width: 100%">登 录
                                    </button>
                                </div>
                            </form>
                        </div>
