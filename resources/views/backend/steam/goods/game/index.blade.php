            ...
            <tr>
                ...
                <td>
                    <button class="layui-btn layui-btn-mini layui-btn-normal" lay-submit=""
                            lay-filter="show"
                            data-route="{{ route('backend.game.show', ['id' => $item->id]) }}">修改
                    </button>
                </td>
            </tr>
        @empty
    ...
    <script>
        layui.use('form', function () {
            ...
            form.on('submit(save-game)', function (data) {
                $.post('{{ route('backend.game.store') }}', {data: data.field}, function (result) {
            ...
            form.on('submit(change-status)', function (data) {
                $.post('{{ route('backend.game.status') }}', {
            ...
            form.on('submit(edit)', function (data) {
                $.post('{{ route('backend.game.edit') }}', {data: data.field, id: data.field.id}, function (result) {
                    layer.msg(result.message);
                }, 'json');
                reload();
                return false;
