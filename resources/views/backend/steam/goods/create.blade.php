    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="game_name" autocomplete="off" placeholder="游戏名" class="layui-input" lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">版本名</label>
            <div class="layui-input-block">
                <input type="text" name="name" autocomplete="off" placeholder="版本名" class="layui-input" lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">面值</label>
            <div class="layui-input-block">
                <input type="text" name="price" autocomplete="off" placeholder="面值" class="layui-input" lay-verify="required|number">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea type="text" style="width: 500px;height: 100px" class="layui-textarea" name="description" lay-verify="required"></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="subid" autocomplete="off" placeholder="subid" class="layui-input" lay-verify="required">
            </div>
        </div>
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate','upload'], function(){
            ...
            form.on('submit(add)', function(data){
                $.post("{{ route('backend.steam.goods.store') }}", {data:data.field}, function (result) {
                    if(result.status == 1){
