    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span>代练订单</span></li>
            </ol>
        </div>
    </div>
    <div class="row">
                    ...
                    <form class="layui-form">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-3">
                                <input type="text" class="layui-input" name="no"  placeholder="平台订单号" value="{{ $no }}">
                            </div>
                            <div class="form-group col-xs-3">
                                <input type="text" class="layui-input" name="foreign_order_no"  placeholder="淘宝订单号" value="{{ $foreignOrderNo }}">
                            </div>
                            <div class="form-group col-xs-3">
                                <input type="text" class="layui-input" name="third_order_no"  placeholder="接单平台订单号" value="{{ $thirdOrderNo }}">
                            </div>
                            <div class="form-group col-xs-2">
                ...
                <div class="main-box-body clearfix">
                    ...
                    <table class="layui-table layui-form" lay-size="sm">
                        ...
                        @forelse($orders as $order)
                            <tr>
                                <td>平台：{{ $order->no }} <br> 淘宝：{{ $order->foreign_order_no }}</td>
