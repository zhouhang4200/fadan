                        ...
                        <div class="main-box-body clearfix">
                            <form role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleTooltip"
                                           data-toggle="tooltip" data-placement="bottom"
                                           title="very nice tooltip about this field">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="examplePwdMeter">Password strength meter (start
                                        typing...)</label>
                                    <input type="password" class="form-control" id="examplePwdMeter"
                                           placeholder="Enter password" data-indicator="pwindicator">
                        ...
                        <div class="main-box-body clearfix">
                            <div class="form-group has-success">
                                ...
                                <span class="help-block"><i
                                            class="icon-ok-sign"></i> Success message</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputFile" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox-nice">
                                    ...
                                    <label for="checkbox-2">
                                        Option two is this and that&mdash;be sure to include why it's
                                        great
                                    </label>
                                </div>
                                <div class="checkbox-nice">
                                    ...
                                    <label for="checkbox-3">
                                        Option three is this and that&mdash;be sure to include why it's
                                        great
                                    </label>
                                </div>
                            </div>
                            ...
                            <form role="form">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="examplePrepend"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group" data-date-format="dd-mm-yyyy">
                                                <input type="text" class="form-control"
                                                       id="datepickerDateComponent" readonly>
