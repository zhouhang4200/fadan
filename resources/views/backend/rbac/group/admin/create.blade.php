                ...
                <div class="main-box-body clearfix">
                    <div class="layui-tab layui-tab-brief" lay-filter="widgetTab">
                        <ul class="layui-tab-title">
                            <li class="layui-this" lay-id="add">添加后台账号角色</li>
                        </ul>
                        <div class="layui-tab-content">
                            <form class="layui-form" method="POST" action="{{ route('admin-groups.store', ['userId' => $user->id]) }}">
                            {!! csrf_field() !!}
                                <div style="width: 40%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="layui-input-inline">
                                                              <input type="checkbox" name="roles[]" lay-skin="primary" title="{{ $role->alias }}" value="{{ $role->id }}">
                                                            </div>
                                                            @endforeach
                                                            </div>
                                                        </td>
