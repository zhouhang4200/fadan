                            ...
                            <div class="layui-tab-item layui-show">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center"><a href="{{ route('groups.edit', ['id' => $group->id])  }}" class="layui-btn layui-btn layui-btn-normal layui-btn-mini">编缉</a>
            ...
            layer.confirm('确定删除吗?', {icon: 3, title:'提示'}, function(index){
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == 1) {
                            layer.msg('删除成功!', {icon: 6, time:1500});                            window.location.href = "{{ route('groups.index') }}";                    
                        } else {
