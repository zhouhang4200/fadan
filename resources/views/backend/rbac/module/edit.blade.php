                                ...
                                <div style="width: 40%">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="name" lay-verify="required" value="{{ old('name') ?: $module->name  }}" autocomplete="off" placeholder="请输入英文模块名" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">中文模块名</label>
                                        <div class="layui-input-block">
                                            <input type="text" name="alias" lay-verify="required" value="{{ old('alias') ?: $module->alias  }}" autocomplete="off" placeholder="请输入中文模块名" class="layui-input">
                                        </div>
                                    </div>
