                            ...
                            {!! csrf_field() !!}
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="name" lay-verify="required|100"  value="{{ old('name') }}" autocomplete="off" placeholder="请输入英文权限名" class="layui-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="alias" lay-verify="required|100"  value="{{ old('alias') }}" autocomplete="off" placeholder="请输入中文权限名" class="layui-input">
                                        </div>
                                    </div>
