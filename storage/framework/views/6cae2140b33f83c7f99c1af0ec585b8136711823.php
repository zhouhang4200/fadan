<?php $__env->startSection('title', ' | 添加后台模块'); ?>
                ...
                <div class="main-box-body clearfix">
                    <div class="layui-tab layui-tab-brief" lay-filter="widgetTab">
                        ...
                        <div class="layui-tab-content">
                            <form class="layui-form" method="POST" action="<?php echo e(route('admin-modules.store')); ?>">
                            <?php echo csrf_field(); ?>
                                ...
                                <div style="width: 40%">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="name" lay-verify="required" value="<?php echo e(old('name')); ?>" autocomplete="off" placeholder="请输入模块名" class="layui-input">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        var createFail = "<?php echo e(session('createFail') ?: ''); ?>";
