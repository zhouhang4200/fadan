    ...
    <div class="wrapper">
        ...
        <div class="nav">
            <ul>
                ...
                <li class="<?php echo e(substr(Route::currentRouteName(), 0, 16) == 'frontend.finance' ? 'current' : ''); ?>"><a href="<?php echo e(route('frontend.finance.asset')); ?>">财务</a><div class="arrow"></div></li>
