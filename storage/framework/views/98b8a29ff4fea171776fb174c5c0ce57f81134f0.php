<?php $__env->startSection('title', ' | 修改后台账号角色'); ?>
                ...
                <div class="main-box-body clearfix">
                    <div class="layui-tab layui-tab-brief" lay-filter="widgetTab">
                        <ul class="layui-tab-title">
                            <li class="layui-this" lay-id="add">修改后台账号角色</li>
                        </ul>
                        <div class="layui-tab-content">
                            <form class="layui-form" method="POST" action="<?php echo e(route('admin-groups.update', ['userId' => $user->id])); ?>">
                            <?php echo csrf_field(); ?>
