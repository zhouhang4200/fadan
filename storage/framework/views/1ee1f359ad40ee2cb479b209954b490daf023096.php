<?php $__env->startSection('title', ' | 添加前台账号角色'); ?>
                ...
                <div class="main-box-body clearfix">
                    <div class="layui-tab layui-tab-brief" lay-filter="widgetTab">
                        ...
                        <div class="layui-tab-content">
                            <form class="layui-form" method="POST" action="<?php echo e(route('groups.store', ['userId' => $user->id])); ?>">
                            <?php echo csrf_field(); ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="layui-input-inline">
                                                              <input type="checkbox" name="roles[]" lay-skin="primary" title="<?php echo e($role->alias); ?>" value="<?php echo e($role->id); ?>">
                                                            </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        var storeError = "<?php echo e(session('storeError') ?: ''); ?>";
        var missRole = "<?php echo e(session('missRole') ?: ''); ?>";

        if (error) {
            layer.msg(error, {icon: 5, time:1500},);
        } else if(storeError) {
            layer.msg(storeError, {icon: 5, time:1500},);
        } else if(missRole) {
