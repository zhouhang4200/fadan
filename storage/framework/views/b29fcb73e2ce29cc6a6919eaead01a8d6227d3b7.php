                ...
                <div class="container">
                    <div class="warp">
                        <div class="content">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.login')); ?>"  class="layui-form">
                                <?php echo csrf_field(); ?>

                                <div class="layui-form-item">
                                    <input type="text" name="name" required="" lay-verify="required" placeholder="请输入账号" value="<?php echo e(old('name')); ?>" autocomplete="off" class="layui-input layui-form-danger input-text">
